...
* Use Amazon's free SSL service, which means your readers get an encrypted secure connection, `https://` in your URL, that nice padlock in your address bar and better Google page rankings.
